...
fun interface LevelUpCallback {
    ...
    companion object {
        @JvmField
        val EVENT: Event<LevelUpCallback> = EventFactory.createArrayBacked(LevelUpCallback::class.java) { listeners ->
            return@createArrayBacked LevelUpCallback { player, id, newLevel, hideMessages ->
